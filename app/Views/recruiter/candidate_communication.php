...
.recruiter-message-card .card-header {
    align-items: center;
...
.recruiter-message-bubble--self {
    background: #eafafa;
    border-color: #bdecec;
}
.recruiter-message-bubble--other {
    background: #f3f7fb;
}
...
.recruiter-message-chip {
    border-radius: 999px;
    font-size: 11px;
    font-weight: 700;
    padding: 3px 8px;
}
.recruiter-message-chip--email {
    background: #fff7e6;
    color: #9a5a00;
}
.recruiter-message-chip--portal {
    background: #eef4ff;
    color: #3156a5;
}
.recruiter-message-subject {
    display: block;
    font-size: 14px;
    margin-bottom: 6px;
}
...
.recruiter-message-card .card-footer {
    border-top: 1px solid #d7e5f2;
    padding: 12px 20px;
}
.recruiter-message-card textarea.form-control {
    border-color: #cce7e9;
    border-radius: 8px;
    min-height: 84px;
    resize: vertical;
