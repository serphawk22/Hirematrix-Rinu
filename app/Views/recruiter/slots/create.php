            ...
            <div class="card shadow-sm recruiter-form-card recruiter-rounded-hidden">
                <div class="card-body">
                    ...
                    <ul class="recruiter-help-list mb-0">
                        <li class="recruiter-light-text">Select a job position for the interview slots.</li>
                        <li class="recruiter-light-text">Choose start date and optionally an end date for multiple days.</li>
                        <li class="recruiter-light-text">Add one or more time slots for each day.</li>
                        <li class="recruiter-light-text">Set capacity for how many candidates can book each slot.</li>
                        <li class="recruiter-light-text">Optionally exclude weekends from the date range.</li>
                        <li class="recruiter-light-text">The system will automatically create all combinations.</li>
                    </ul>
                </div>
            </div>
