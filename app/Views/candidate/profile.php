...
<section class="site-section pt-0 content-wrap">
    <div class="container">
        ...
        <div class="dashboard-panel mb-4">
            ...
            <div class="panel-body profile-progress-panel">
                <div class="progress profile-progress-track">
                    <div class="progress-bar profile-progress-bar candidate-progress-fill" role="progressbar"
                         style="--candidate-progress:<?= (int) $completion['percentage'] ?>%;"
...
<iframe id="rsDownloadFrame" class="candidate-hidden-frame" aria-hidden="true"></iframe>
